...
import static com.zeuscompany.furnitureshop.MainActivity.listData_main_search;
...
public class ItemPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if(getResources().getString(R.string.local).equals("en"))
        {
        ...
        for(int j=0;j<listData_main_search.size();++j)
        {
            if(item_id.equals(listData_main_search.get(j).getItem_id()))
            {
                ...
                price.setText("AED "+listData_main_search.get(j).getPrice());
