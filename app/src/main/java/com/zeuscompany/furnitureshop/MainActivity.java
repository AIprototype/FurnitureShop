package com.zeuscompany.furnitureshop;
...
import com.zeuscompany.furnitureshop.adapters.CustomAdapter_filter;
import com.zeuscompany.furnitureshop.adapters.CustomAdapter_main_search;
import com.zeuscompany.furnitureshop.modals.FilterModal;
import com.zeuscompany.furnitureshop.modals.MainItemModal;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void sideDrawerInitialisation()
    {
        ...
        Glide.with(this).load("https://i.ytimg.com/vi/XdIZ_RqxDMU/maxresdefault.jpg")
...
//        }
    ...
    private void getCartItems()
    {
        ...
        if(!tiny_text.equals(""))
        {
            ...
            Type type = new TypeToken<ArrayList<MyData_cart>>(){}.getType();
