package com.zeuscompany.furnitureshop.adapters;
...
import com.zeuscompany.furnitureshop.CartView;
import com.zeuscompany.furnitureshop.R;
import com.zeuscompany.furnitureshop.interfaces.ItemClickListener;
import com.zeuscompany.furnitureshop.modals.MyData_cart;
...
import static com.zeuscompany.furnitureshop.MainActivity.my_data_list_cart;
...
public class CustomAdapter_cart extends RecyclerView.Adapter<RecyclerViewHolder_cart>
{
    ...
    public void onBindViewHolder(final RecyclerViewHolder_cart holder, final int position)
    {
        ...
        {
            if(context.getResources().getString(R.string.local).equals("en"))
            {
            ...
            holder.cartItemPrice.setText("AED "+" "+listData.get(position).getPrice());
            ...
            holder.cartItemCurrency.setText("AED");
            ...
            holder.itemIncrease.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v)
                {
                    ...
                    CartView.getCartTotalValue().setText("AED "+total);
